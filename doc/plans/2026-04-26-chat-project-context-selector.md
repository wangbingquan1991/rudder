...
- `pnpm test:run` ran the suite and failed only in the existing `@rudderhq/cli` organization import/export E2E, where a round-trip export duplicated catalog skills and cleanup hit a non-empty temp directory.
- Passed: `pnpm build`
