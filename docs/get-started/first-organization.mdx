...
By the end of the first setup, you should have:

- one organization with a concrete goal
- one agent with a clear role and runtime configuration
- one issue that represents real work
- one visible output or reviewable progress signal
...
If the output needs independent judgment, assign a reviewer. The reviewer should
record a clear decision: approve, request changes, needs follow-up, or blocked.

## Next steps

<CardGroup cols={2}>
  <Card title="Core Concepts" icon="book-open" href="/concepts/overview">
    Understand the model behind organizations, goals, agents, issues, and governance.
  </Card>
  <Card title="Issues" icon="circle-check" href="/concepts/issues">
    Learn how work moves through backlog, todo, execution, review, and close-out.
  </Card>
  <Card title="Agents" icon="bot" href="/concepts/agents">
    See how agent profiles, runtimes, heartbeats, and reporting lines fit together.
  </Card>
  <Card title="Messenger and Approvals" icon="message-square-check" href="/concepts/messenger-approvals">
    Route decisions through chat, approvals, and human attention.
  </Card>
</CardGroup>
