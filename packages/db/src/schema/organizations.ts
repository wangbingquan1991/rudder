...
export const organizations = pgTable(
  ...
  (table) => ({
    issuePrefixUniqueIdx: uniqueIndex("organizations_issue_prefix_idx").on(table.issuePrefix),
    urlKeyUniqueIdx: uniqueIndex("organizations_url_key_idx").on(table.urlKey),
  }),
);
