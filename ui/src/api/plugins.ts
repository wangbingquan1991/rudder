/**
 * @fileoverview Frontend API client for the Rudder plugin system.
 *
...
export const pluginsApi = {
   ...
   *
   * @param params.packageName - npm package name (e.g. `@rudderhq/plugin-linear`)
   ...
   * @param orgId - Optional organization scope used for board/organization access checks.
   ...
   *
   * Error responses:
   * - `401`/`403` when auth or organization access checks fail
