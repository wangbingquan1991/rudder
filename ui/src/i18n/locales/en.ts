export const en = {
  ...
  "general.gitIdentity.description": "Confirm the operator name and email Rudder injects into local agent runtimes before they create Git commits.",
  ...
  "general.gitIdentity.cliAuthNote": "Trusted local runtimes share common host CLI credentials such as gh and SSH, while Git author identity is guarded separately with user.useConfigOnly.",
