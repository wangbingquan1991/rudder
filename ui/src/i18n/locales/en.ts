export const en = {
  ...
  "general.typography.title": "Typography",
  "general.typography.fontFamily": "Font Family",
  "general.typography.fontFamilyDescription": "Choose font family for the entire interface",
  "general.typography.fontSize": "Font Size",
  "general.typography.fontSizeDescription": "Adjust base font size. Current:",
  "general.typography.options.inter.label": "Inter",
  "general.typography.options.inter.description": "Clean modern design default",
  "general.typography.options.system.label": "System",
  "general.typography.options.system.description": "Use native OS font",
  "general.typography.options.jetbrains.label": "JetBrains",
  "general.typography.options.jetbrains.description": "Developer-friendly reading",
  "general.typography.options.lexend.label": "Lexend",
  "general.typography.options.lexend.description": "Improved readability",
  "general.typography.options.xiawu.label": "LXGW WenKai Mono",
  "general.typography.options.xiawu.description": "Open-source Chinese monospace, comfortable reading",
  "general.typography.searchFont": "Search fonts...",
  "general.typography.noFontFound": "No font found",
  "general.typography.uiScale": "UI Scale",
  "general.typography.uiScaleDescription": "Scale the entire interface. Current:",
  ...
  "about.updates.progress.phase.ready_to_install": "Downloaded and verified. Restart to finish the update.",
  "about.updates.progress.phase.waiting_for_active_runs": "Waiting for active runs...",
