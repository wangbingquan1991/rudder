  ...
  return (
    <div className="space-y-10 max-w-4xl">
      ...
      <Section title="Colors">
        <SubSection title="Semantic surfaces">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
            ...
            <Swatch name="Shell" cssVar="--surface-shell" />
            <Swatch name="Inset" cssVar="--surface-inset" />
            <Swatch name="Elevated" cssVar="--surface-elevated" />
            <Swatch name="Overlay" cssVar="--surface-overlay" />
            <Swatch name="Proposal" cssVar="--surface-proposal" />
          </div>
        </SubSection>

        <SubSection title="Semantic ink and accent">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
            <Swatch name="Ink strong" cssVar="--ink-strong" />
            <Swatch name="Ink base" cssVar="--ink-base" />
            <Swatch name="Ink muted" cssVar="--ink-muted" />
            <Swatch name="Accent soft" cssVar="--accent-soft" />
            <Swatch name="Accent base" cssVar="--accent-base" />
            <Swatch name="Accent strong" cssVar="--accent-strong" />
          </div>
        </SubSection>
      ...
      <Section title="Typography">
        <div className="space-y-3">
          <h2 className="font-display text-3xl leading-none">Display Heading — font-display text-3xl</h2>
          <h2 className="text-lg font-semibold">Section Title — text-lg font-semibold</h2>
          <h3 className="text-sm font-semibold text-muted-foreground">
            Section heading — text-sm font-semibold text-muted-foreground
          </h3>
        ...
        <SubSection title="Run invocation badges">
          <div className="flex items-center gap-2 flex-wrap">
            {[
              ...
              ["review", "bg-amber-100 text-amber-700 dark:bg-amber-900/45 dark:text-amber-300"],
      ...
      <Section title="Breadcrumb">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="#">Rudder App</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
